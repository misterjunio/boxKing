...
<div class="container user_page">
	<div class="row">
		<div id="user_index_options" class="col-md-8 col-md-offset-2">
			<button id="all_users" type="button" class="btn btn-info">All users</button>
			<button id="already_paid" type="button" class="btn btn-info line_item">Already paid</button>
			<button id="payment_missing" type="button" class="btn btn-info line_item active">Payment missing</button>
		</div>
		<div class="col-md-8 col-md-offset-2" style="margin-top:1%">
			<div style="margin-bottom: 0" class="panel panel-default">
				<div class="panel-heading">Payment missing</div>
